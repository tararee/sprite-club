...
var tyler="tyler.png";
var npc;
var tylerDirection = "RIGHT";
var tylerSTATE = "IDLE"; //
var
spriteTyler= "tyler.png";
//var spriteSheetKahoona="https://farm1.staticflickr.com/772/20801037743_6c4ea2f91b_k.jpg";
var spriteSheetPanda = "spriteSheetPanda.png"
//previously ninja
...
function init() {
  ...
  loader.crossOrigin = "";
  loader.loadFile({id:"tyler", src:spriteTyler});
	//src above was previously a spritesheet
  loader.loadFile({id:"cpu", src:spriteSheetPanda});
	//src above was previously a spritesheet
}
 ...
 function handleComplete(evt) {
      ...
      "animations":{
		...
		tyler = new createjs.Sprite(spriteSheet, "Ready");
		tyler.x = 100;
		tyler.y = 50;
...
//Attack animation must finish before movement can occur
	switch (e.keyCode) {
     //====SPACE KEY======
		case KEYCODE_SPACE: 
			if(tyler.currentAnimation != "Melee"){
				tyler.gotoAndPlay("Melee");
				tylerSTATE = "Melee";
	...
	function runningState(direction){
		if(tyler.currentAnimation != "Melee"){
			...
			if(direction == "UP" || direction == "DOWN"){
				...
				if(tylerDirection != direction)
					tyler.scaleX *= -1;
				tylerDirection = direction;
				xKeyHeld = direction;
			}
		}
	}
...
*/
	function resetState(){
		if(xKeyHeld === "NONE" && yKeyHeld === "NONE" && tylerSTATE === "RUN"){
			tylerSTATE = "IDLE";
			tyler.gotoAndPlay("Ready");
		}
	}
...
initiateCharacter(tyler, "tyler_hp", "tyler_stats");
